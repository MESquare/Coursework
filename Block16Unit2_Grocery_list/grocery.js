...
function findItemById(id) {
  // TODO: Use the .find() method to return the item whose id matches the passed-in id
...
function calculateTotalInventory() {
  return items.reduce ((total, item => total + item.inventory, 0); // TODO Use the .reduce() method to return the total number of items in inventory
}
...
function filterItemsByCategoryId(categoryId) {
  // TODO: use the .filter() method to filter out all items which don't belong to the passed-in category
}
